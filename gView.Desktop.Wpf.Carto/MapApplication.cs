...
namespace gView.Desktop.Wpf.Carto
{
    ...
    {
        private gView.Desktop.Wpf.Carto.MainWindow _appWindow = null;
        ...
        public MapApplication(gView.Desktop.Wpf.Carto.MainWindow appWindow, LayoutDocumentPane dataViewContainer)
            : base()
        {
    ...
    {
        private gView.Desktop.Wpf.Carto.MainWindow _appWin;

        public MapStatusBar(gView.Desktop.Wpf.Carto.MainWindow app)
        {
            _appWin = app;
        }
