...
namespace gView.Framework.UI.Controls
{
    ...
    public class TOCControl : System.Windows.Forms.UserControl, IDockableWindow
    {
        ...
        public TOCControl()
        {
            ...
            foreach (XmlNode contextItem in compMan.GetPluginNodes(Plugins.Type.IDatasetElementContextMenuItem))
            {

                IDatasetElementContextMenuItem contextMenuItem = (IDatasetElementContextMenuItem)compMan.CreateInstance(contextItem);
        ...
        void LockLayer_Click(object sender, EventArgs e)
        {
            ...
            buildList(list.Items[list.Items.IndexOf(_contextItem) - 1]);
        }
        ...
        internal void buildList(object FromItem)
        {
            FromItem = null;
            if (FromItem == null)
            {
        ...
        private void ShowDatasetLayers(DatasetItem item)
        {
        ...
        private void list_DrawItem(object sender, System.Windows.Forms.DrawItemEventArgs e)
        {
            ...
            if (item is MapItem)
            {
                e.Graphics.DrawImage(
                    global::gView.Dialogs.Properties.Resources.layers,
        ...
        private void list_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (item is DatasetItem)
            {
                if (X >= 1 && X <= 10)
                {
                    ...
                    ShowDatasetLayers((DatasetItem)item);
                }
            }
            if (item is DatasetLayerItem)
            {
