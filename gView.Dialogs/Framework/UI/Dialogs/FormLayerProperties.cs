...
namespace gView.Framework.UI.Dialogs
{
	...
	public class FormLayerProperties : System.Windows.Forms.Form
	{
		...
		{	
            ...
            foreach (XmlNode compNode in compMan.GetPluginNodes(Plugins.Type.ILayerPropertyPage))
            {
                ILayerPropertyPage page = PlugInManager.Create(compNode) as ILayerPropertyPage;
		...
		private void InitializeComponent()
		{
            ...
            this.btnFieldsMoveDown.Image = global::gView.Dialogs.Properties.Resources.arrow_down_16;
            ...
            this.btnFieldsMoveUp.Image = global::gView.Dialogs.Properties.Resources.arrow_up_16;
        ...
        private void MakeSelectionRendererTree()
        {
            ...
            foreach (XmlNode xmlnode in compManager.GetPluginNodes(Plugins.Type.IFeatureRenderer))
            {
                IFeatureRenderer selRenderer = (IFeatureRenderer)compManager.CreateInstance(xmlnode);
