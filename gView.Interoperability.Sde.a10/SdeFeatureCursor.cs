...
namespace gView.Interoperability.Sde.a10
{
    internal class SdeFeatureCursor : FeatureCursor
    {
        ...
        private SdeStream _stream = null;
                   ...
                   (filter != null) ? filter.FeatureSpatialReference : null)
        {
            try
            {
                if (filter != null && !filter.SubFields.Contains("*")) filter.AddField(tc.IDFieldName, false);
                ...
                if (!_connection.Open(this._dataset)) return;
        ...
        public override IFeature NextFeature
        {
            get
            {
                while (true)
                {
                    ...
                    Int32 err_no;
                    err_no = Wrapper10.SE_stream_fetch(_stream.SeStream);
                    ...
                    if (_spatialFilter != null && feature != null && feature.Shape != null)
                    {
        ...
        {
            System.Int32 val = 0;
            System.Int32 err_no = Wrapper10.SE_stream_get_integer(_stream.SeStream, index, ref val);
        ...
        {
            System.Int16 val = 0;
            System.Int32 err_no = Wrapper10.SE_stream_get_smallint(_stream.SeStream, index, ref val);
        ...
        {
            System.Double val = 0;
            System.Int32 err_no = Wrapper10.SE_stream_get_double(_stream.SeStream, index, ref val);
        ...
        {
            float val = 0;
            System.Int32 err_no = Wrapper10.SE_stream_get_float(_stream.SeStream, index, ref val);
        ...
        private string FetchString(System.Int16 index, int size)
        {
            try
            {
                ...
                System.Int32 err_no = Wrapper10.SE_stream_get_string(_stream.SeStream, index, buffer);
