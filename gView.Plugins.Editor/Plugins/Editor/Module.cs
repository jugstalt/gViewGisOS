...
namespace gView.Plugins.Editor
{
    ...
    class Module : IMapApplicationModule, IModule, IPersistable
    {
        ...
        public bool PerformInsertFeature(IFeatureClass fc, IFeature feature)
        {
            ...
            {
                MessageBox.Show(_attributEditor.lastErrorMsg, "ERROR: Commit Values...");
                return false;
            }
            ...
            bool ret = ((IFeatureUpdater)fc.Dataset.Database).Insert(fc, feature);
            feature.Shape = shape;
        ...
        public bool PerformUpdateFeature(IFeatureClass fc, IFeature feature)
        {
            ...
            bool ret = ((IFeatureUpdater)fc.Dataset.Database).Update(fc, feature);
            feature.Shape = shape;
        ...
        private class MapEditLayerPersist : IPersistable
        {
            ...
            public void Load(IPersistStream stream)
            {
                ...
                if (_module.MapDocument.Maps[index] == null ||
                    _module.MapDocument.Maps[index].Name != name) return;

                _map = _module.MapDocument.Maps[index];
            ...
            public void Save(IPersistStream stream)
            {
                ...
                int index = _module.MapDocument.Maps.IndexOf(_map);
                if (index == -1) return;
    ...
    class EditLayer : IEditLayer, IPersistable
    {
        ...
        public EditStatements AllowedStatements
        {
