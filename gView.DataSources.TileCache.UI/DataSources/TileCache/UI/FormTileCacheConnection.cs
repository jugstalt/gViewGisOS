...
namespace gView.DataSources.TileCache.UI
{
    public partial class FormTileCacheConnection : Form
    {
        ...
        public void LoadStream(IPersistStream stream)
        {
            ...
            numTileWidth.Value = (decimal)(int)stream.Load("tile_width", (int)100);
            numTileHeight.Value = (decimal)(int)stream.Load("tile_height", (int)100);

            lstScales.Items.Clear();
            int scales_count = (int)stream.Load("scales_count", (int)0);
            ...
            cmbOrigin.SelectedIndex = (int)stream.Load("extent_origin", (int)0);
