...
namespace gView.Interoperability.ArcXML.UI.ImportAXL
{
    ...
    class LayerContextMenu : IDatasetElementContextMenuItem
    {
        ...
        public void OnEvent(object element, object dataset)
        {
            ...
            try
            {
                ...
                if (element is IFeatureLayer)
                {
                    ...
                    if (selectDlg.ShowDialog() != DialogResult.OK || selectDlg.SelectedNode == null) return;
        ...
        public object Image
        {
            get { return global::gView.Interoperability.ArcXML.UI.Properties.Resources.import; }
        }
        ...
        {
            if (axl == null || layer == null) return null;
            ...
            foreach (XmlNode layerNode in axl.SelectNodes("ARCXML/CONFIG/MAP/LAYER[@type='featureclass']"))
            {
                ...
                if (datasetNode == null || datasetNode.Attributes["name"] == null) continue;
