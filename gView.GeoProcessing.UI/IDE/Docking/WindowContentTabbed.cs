...
{
    [ToolboxItem(false)]
    internal class WindowContentTabbed : WindowContent, IHotZoneSource, IMessageFilter
    {
        // Class constants
            ...
            : base(manager, vs)
        {
            ...
            _tabControl = new IDE.Controls.TabControl();

            // It should always occupy the remaining space after all details
            _tabControl.Dock = DockStyle.Fill;

            // Show tabs only if two or more tab pages exist
            _tabControl.HideTabsMode = IDE.Controls.TabControl.HideTabsModes.HideUsingLogic;
            ...
            _tabControl.DoubleClickTab += new IDE.Controls.TabControl.DoubleClickTabHandler(OnDoubleClickTab);
		...
		public IDE.Controls.TabControl TabControl
		{
		...
		public override void BringContentToFront(Content c)
		{
            ...
            foreach(IDE.Controls.TabPage page in _tabControl.TabPages)
                if (page.Tag == c)
                {
