...
{
    [ToolboxItem(false)]
    internal class TabStub : UserControl
    {
		private class DrawTab
		{
			protected int _index;
			protected Rectangle _drawRect;
            protected IDE.Controls.TabPage _tabPage;
			...
			public IDE.Controls.TabPage TabPage  { get { return _tabPage; } }
        ...
        internal delegate void TabStubIndexHandler(TabStub sender, int pageIndex);
        internal delegate void TabStubHandler(TabStub sender);
		...
		protected void ResizeControl()
		{
			...
			{
				foreach(IDE.Controls.TabPage page in _tabPages)
				{
