...
namespace IDE.Docking
{
    ...
    internal class DockingManager
    {
        ...
        internal delegate void ContentHandler(Content c, EventArgs cea);
        internal delegate void ContentHidingHandler(Content c, CancelEventArgs cea);
        internal delegate void ContextMenuHandler(PopupMenu pm, CancelEventArgs cea);
		internal delegate void TabControlCreatedHandler(IDE.Controls.TabControl tabControl);
		internal delegate void SaveCustomConfigHandler(XmlTextWriter xmlOut);
        internal delegate void LoadCustomConfigHandler(XmlTextReader xmlIn);
		...
		public virtual void OnTabControlCreated(IDE.Controls.TabControl tabControl)
		{ 
