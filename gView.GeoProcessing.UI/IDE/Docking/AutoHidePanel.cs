...
{
    [ToolboxItem(false)]
    internal class AutoHidePanel : Panel, IMessageFilter
	{
		[ToolboxItem(false)]
        ...
        protected TabStub TabStubForContent(Content c)
        {
            ...
            foreach(TabStub ts in this.Controls)
            {
                ...
                foreach(IDE.Controls.TabPage page in ts.TabPages)
                {
        ...
        public void AddContentIntoTabStub(Content content, TabStub ts, int index)
        {
            ...
            IDE.Controls.TabPage page = new IDE.Controls.TabPage();
        ...
        public void AddContentsAsGroup(ContentCollection contents, int index)
		{
            ...
            wct.TabControl.HideTabsMode = IDE.Controls.TabControl.HideTabsModes.HideAlways;
        ...
        public void RemoveContent(Content c)
        {
            ...
            IDE.Controls.TabPage targetPage = null;
