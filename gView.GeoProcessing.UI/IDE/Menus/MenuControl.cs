...
namespace IDE.Menus
{
    ...
    [Designer(typeof(IDE.Menus.MenuControlDesigner))]
    internal class MenuControl : ContainerControl, IMessageFilter
    {
        ...
        static MenuControl()
        {
            ...
            _menuImages = ResourceHelper.LoadBitmapStrip(Type.GetType("IDE.Menus.MenuControl"),
