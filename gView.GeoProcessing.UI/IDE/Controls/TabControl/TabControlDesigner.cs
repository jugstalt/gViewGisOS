...
{
    internal class TabControlDesigner :  System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        public override ICollection AssociatedComponents
        {
            get 
            {
                if (base.Control is IDE.Controls.TabControl)
                    return ((IDE.Controls.TabControl)base.Control).TabPages;
                else
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            if (msg.Msg == (int)Win32.Msgs.WM_LBUTTONDOWN)
            {
                ...
                IDE.Controls.TabControl tabControl = this.SelectionService.PrimarySelection as IDE.Controls.TabControl;
