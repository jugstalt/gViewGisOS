...
{
    internal class TGCloseRequestEventArgs
	{
    ...
    internal class TGContextMenuEventArgs : TGCloseRequestEventArgs
    {
    ...
    internal class TGPageLoadingEventArgs
    {
        protected Controls.TabPage _tp;
    ...
    internal class TGPageSavingEventArgs
    {
        protected Controls.TabPage _tp;
