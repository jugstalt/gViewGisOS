...
{
    internal class WizardControlDesigner :  System.Windows.Forms.Design.ParentControlDesigner
    {
        ...
        public override ICollection AssociatedComponents
        {
            get 
            {
                if (base.Control is IDE.Controls.WizardControl)
                    return ((IDE.Controls.WizardControl)base.Control).WizardPages;
                else
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            {
                IDE.Controls.WizardControl wizardControl = this.SelectionService.PrimarySelection as IDE.Controls.WizardControl;

                // Check we have a valid object reference
                if (wizardControl != null)
                {
                    IDE.Controls.TabControl tabControl = wizardControl.TabControl;
