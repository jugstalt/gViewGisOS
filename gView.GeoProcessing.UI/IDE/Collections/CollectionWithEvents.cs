...
namespace IDE.Collections
{
    // Declare the event signatures
    internal delegate void CollectionClear();
    internal delegate void CollectionChange(int index, object value);

    internal class CollectionWithEvents : CollectionBase
    {
