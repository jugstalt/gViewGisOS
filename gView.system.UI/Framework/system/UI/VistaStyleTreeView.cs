    ...
    public class VistaStyleTreeView : TreeView
    {
        ...
        void VistaStyleTreeView_DrawNode(object sender, DrawTreeNodeEventArgs e)
        {
            ...
            if (e.Node.Nodes.Count > 0)
            {
                ...
                {
                    g.DrawImage(gView.system.UI.Properties.Resources.tree_minus, expanderBounds, new Rectangle(0, 0, 9, 9), GraphicsUnit.Pixel);
                }
                else
                {
                    g.DrawImage(gView.system.UI.Properties.Resources.tree_plus, expanderBounds, new Rectangle(0, 0, 9, 9), GraphicsUnit.Pixel);
                }
            }
