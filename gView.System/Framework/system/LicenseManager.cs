...
namespace gView.Framework.system
{
    public class CLicenseManager
    {
        ...
        public int DurationDaysLeft
        {
            get
            {
                if (_runType == LicenseTypes.Express)
                {
                    DateTime t1 = SystemVariables.InstallationTime;
                    TimeSpan ts = DateTime.Now - t1;

                    return Math.Max(0, _durationDays - ts.Days);
                }
                else if (_runType == LicenseTypes.Unknown || _runType == LicenseTypes.Expired)
                {
                    return -1;
                }
                return 1;
    ...
    public class License : ILicense
    {
        ...
        public int DurationDaysLeft
        {
            get { return _lic.DurationDaysLeft; }
        }
